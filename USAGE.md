...
Lime is a bold marketing UI kit (lime · big type · gradient accents). It's a
...
```bash
git clone https://github.com/uikit-studio/lime-uikit my-app
...
The bundled skill (`.claude/skills/lime`) gives the AI Lime's components, tokens,
...
.claude/   skills/lime  (the consumer skill)
